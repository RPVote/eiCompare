...
devtools::install_github("DSSG-eiCompare/eiCompare@density_visualization")
library(eiCompare)
...
There are many sources online if you'd like to learn more about parallelization in general.
...
So for this analysis there are 5 candidates (Husted, Spiegel, Ruth, Button, and Montanez) and 3 racial groups (Hispanic/Latino, Asian, and White). With that, let's set up the inputs we need for the function and time it to see how long it takes to complete the iterative ei analysis without parallelization.
