...
[Optional] Loading a shapefile using the `tigris` package:
...
```{r}
bisg_dfsub <- bisg_df %>%
  select(BLOCKCE10, pred.whi, pred.bla, pred.his, pred.asi, pred.oth)
...
bisg_sf <- left_join(gwin_fulton_shape, bisg_dfsub, by = "BLOCKCE10")
```
