...
#### Loading Voter Files
**First, check the full GA voter registration file, `ga_5k`, to make sure the dataset has properly downloaded.**
...
**There are 5000 registered voters in Gwinnett and Fulton counties.**
...
If you are able to readily locate addresses that have typos or errors, great! However, let's take a look at unique addresses in a table to understand why many of these addresses are missing. 
...
11 voters are missing zipcodes and street names.
...
# Check that zipcodes have been properly formatted
...
geocoded_data_full_geo <- run_geocoder(
  ...
  census_benchmark = "Public_AR_Current",
  census_output = "full",
  census_vintage = "Public_AR_Current",
  census_class = "sf",
  opencage_key = NULL
)
```
