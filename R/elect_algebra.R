...
#'   pct_voted = c(
#'     0.2527662, 0.1464147, 0.3805668, 0.2725254, 0.3645714,
#'     0.1147669, 0.2186014, 0.2468419, 0.2706941, 0.1431600
#'   ),
#'   pct_novote = c(
#'     0.7472338, 0.8535853, 0.6194332, 0.7274746, 0.6354286,
#'     0.8852331, 0.7813986, 0.7531581, 0.7293059, 0.8568400
#'   ),
#'   pct_white = c(
#'     0.9021392, 0.5914871, 0.9272874, 0.9674376, 0.5517143,
#'     0.2318760, 0.6050911, 0.7162854, 0.6161954, 0.3186043
#'   ),
#'   pct_nonwhite = c(
#'     0.0978608, 0.4085129, 0.0727126, 0.0325624, 0.4482857,
...
#'   pct_cand_a_voters = c(
#'     0.31712062, 0.89867310, 0.01957447, 0.04480652,
#'     0.24294671, 0.80660836, 0.24195741, 0.53665284,
#'     0.75213675, 0.70273349
#'   ),
#'   pct_cand_b_voters = c(
#'     0.6828794, 0.1013269, 0.9804255, 0.9551935, 0.7570533,
...
elect_algebra <- function(totals,
  ...
  out$Pct_White <- c(
    round(out$White_Vote[1] / out$White_Vote[3], 3),
    round(out$White_Vote[2] / out$White_Vote[3], 3), ""
  )

  out$Pct_NonWhite <- c(
    round(out$NonWhite_Vote[1] / out$NonWhite_Vote[3], 3),
